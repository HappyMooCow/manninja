define(['app/LocalID', 'app/Repository', 'app/Type', 'app/Item', 'app/CollectionOfType', 'app/Field', 'app/Form', 'app/Zookeeper', 'app/Parser', 'app/itemForm', 'widgets/newTypeForm', 'widgets/table', 'widgets/Menu', 'widgets/Display', 'widgets/Sidebar', 'app/notifier'], function (LocalID, Repository, Type, Item, collectionOfType, Field, Form, zookeeper, parser, itemForm, ntf, table, menu, display, sidebar, notifier) {
    ...
    **/  
    Architecture = (function () {
        var t = new CA();
        function CA() {
            this._LocalID = new LocalID();
            this._Items = new Repository(this.events);
            this._Types = new Repository(this.events);
            this._Forms = new Repository(this.events);
            this._Tags = new Repository(this.events);
            this._Fields = new Repository(this.events);
            this._Keeper = new zookeeper();
            ...
            var _LocalID = this._LocalID,
                _Items = this._Items,
                _Types = this._Types,
                _Forms = this._Forms,
                _Tags = this._Tags,
                _Keeper = this._Keeper,
                _Fields = this._Fields,
                events = this.events,
                notify = this._Notifier;
